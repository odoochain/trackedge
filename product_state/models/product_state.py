...
class ProductState(models.Model):
    ...
    inherit_from_previous = fields.Boolean(help='When set, Availability will not be updated, it will inherit the Availability from the last inventory location Availability')
    # TODO
    # Make this field affecting the quant created.
