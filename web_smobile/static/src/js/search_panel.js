odoo.define('web_smobile_ce.ControlPanel', function (require) {
    "use strict";
     ...
     */
    ControlPanel.patch('web_smobile_ce.ControlPanel', T => {
        class ControlPanelPatchSmobile extends T {
        ...
        ControlPanelPatchSmobile.components.Portal = Portal;
        ControlPanelPatchSmobile.template = 'web_smobile_ce.ControlPanel';

        return ControlPanelPatchSmobile;
    });
});
